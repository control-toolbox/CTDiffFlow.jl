...
function build_∂x0_flow_var(
    ...
    function ∂x0_flow(
        t0::Real, x0::Vector{<:Real}, tf::Real, λ::Vector{<:Real}; ode_kwargs...
    )
...
function build_∂λ_flow_var(
    ...
    function ∂λ_flow(
        tspan::Tuple{<:Real,<:Real}, x0::Function, λ::Vector{<:Real}; ode_kwargs...
    )
        x0λ = x0(λ)
        #=
